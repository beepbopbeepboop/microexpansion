...
me.set_speed("technic:coal_alloy_furnace", 1)
...
-- HV furnace "cooking" only has 4 output slots
me.register_max("technic:chromium_ingot", 99*4)
--me.register_max("technic:uranium_ingot", 99*4)
me.register_max("technic:zinc_ingot", 99*4)
me.register_max("technic:lead_ingot", 99*4)
me.register_max("technic:cast_iron_ingot", 99*4)

-- HV grinder only has 4 output slots
me.register_max("technic:coal_dust", 99*4)
me.register_max("technic:copper_dust", 99*4)
me.register_max("technic:gold_dust", 99*4)
me.register_max("technic:wrought_iron_dust", 99*4)
me.register_max("technic:tin_dust", 99*4)
me.register_max("technic:chromium_dust", 99*4)
me.register_max("technic:uranium_dust", 99*4)
me.register_max("technic:zinc_dust", 99*4)
me.register_max("technic:lead_dust", 99*4)
me.register_max("technic:sulfur_dust", 99*4)
me.register_max("technic:stone_dust", 99*4)
me.register_max("default:gravel", 99*4)
me.register_max("default:sand", 99*4)
me.register_max("default:snowblock", 99*4)
me.register_max("technic:rubber_tree_grindings", 99*4)
me.register_max("technic:technic:silver_dust", 99*4)

-- MV alloy furnace only has 4 output slots
me.register_max("technic:doped_silicon_wafer", 99*4)
me.register_max("technic:silicon_wafer", 99*4)
me.register_max("basic_materials:brass_ingot", 99*4)
me.register_max("default:bronze_ingot", 99*4)
me.register_max("technic:stainless_steel_ingot", 99*4)
me.register_max("technic:rubber", 99*4)
me.register_max("bucket:bucket_lava", 4)
me.register_max("technic:carbon_steel_ingot", 99*4)

-- LV extractor only has 4 output slots
me.register_max("technic:raw_latex", 99*4)

-- HV compressor only has 4 output slots
me.register_max("technic:composite_plate", 99*4)
me.register_max("technic:copper_plate", 99*4)
me.register_max("technic:graphite", 99*4)
me.register_max("technic:carbon_plate", 99*4)
me.register_max("technic:uranium_fuel", 99*4)
me.register_max("default:diamond", 99*4)

-- freezer only has 4 output slots
me.register_max("default:ice", 99*4)
...
me.register_output_to_inputs("technic:lead_dust", { ItemStack("technic:lead_lump") })
